...
public class CheckoutPage {
	...
	private By amountPayByCheck = By.cssSelector
			("#payment-option-1-additional-information > section:nth-child(1) > dl:nth-child(2) > dd:nth-child(2)");
	
	private By checkbosIAgree = By.cssSelector("#conditions_to_approve\\[terms-and-conditions\\]");
	...
	public void selecionarCheckBoxIAgree() {
		driver.findElement(checkbosIAgree).click();
	}
	
	public boolean estaSelecionadoCheckBoxIAgree() {
		return driver.findElement(checkbosIAgree).isSelected();
	}
